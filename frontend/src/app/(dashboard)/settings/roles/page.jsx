    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mt-4">Loading roles and permissions...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-400 mt-1">Configure permissions for each role</p>
      </div>
              ...
              <div className="divide-y divide-gray-200">
                {roles.map((role) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 hover:bg-transparent/5 transition-colors ${
                      selectedRole?.id === role.id ? 'bg-blue-50 border-l-4 border-blue-500' : ''
                    }`}
                  >
                    <div className="font-medium text-gray-100">{role.roleName}</div>
              ...
              <CardContent>
                <div className="space-y-6">
                  {Object.entries(groupedPermissions).map(([module, modulePermissions]) => {
                    ...
                    return (
                      <div key={module} className="border border-white/10 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="font-semibold text-gray-100 capitalize">{module}</h4>
                          <button
