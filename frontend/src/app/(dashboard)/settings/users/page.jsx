  ...
  return (
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="bg-transparent shadow-sm rounded-lg overflow-hidden">
                ...
                <tr key={user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <select
                      ...
                      className="text-sm border-white/20 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div className="mt-3">
              ...
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-white/20 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
                      handleResetPassword();
                    }
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-gray-300 text-gray-300 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500"
                >
                  Cancel
                </button>
              </div>
