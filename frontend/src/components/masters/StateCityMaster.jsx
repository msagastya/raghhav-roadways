...
export default function StateCityMaster() {
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div className="space-y-2">
            <div className="h-6 w-48 bg-gray-200 dark:bg-white/10 rounded animate-pulse"></div>
            <div className="h-4 w-64 bg-gray-200 dark:bg-white/10 rounded animate-pulse"></div>
          </div>
          <div className="h-10 w-28 bg-gray-200 dark:bg-white/10 rounded animate-pulse"></div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-7">
            <Card animate={false}>
              <CardContent className="p-4 sm:p-6">
                <div className="h-40 bg-gray-200 dark:bg-white/10 rounded animate-pulse"></div>
              </CardContent>
            </Card>
          </div>
        </div>
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">State & City Master</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-5">
          <Card>
            <CardHeader>
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">States of India</h3>
            </CardHeader>
                    ...
                    {states.map((state, index) => (
                      ...
                      >
                        ...
                        <TableCell className="text-right">
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-white/10 text-gray-800 dark:text-gray-300">
              ...
              <CardContent className="p-3 sm:p-4 lg:p-6">
                {cities.length === 0 ? (
                  <div className="text-center py-8 sm:py-12">
                    <p className="text-sm sm:text-base text-gray-500 dark:text-white/60">No cities found for this state</p>
                    <Button
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
                    {cities.map((city, index) => (
                      <motion.div
                        key={city.id}
                        className="px-3 sm:px-4 py-2 bg-gradient-to-br from-gray-50 to-white dark:from-white/5 dark:to-white/[0.02] rounded-lg border border-gray-200 dark:border-white/10 hover:border-primary-300 dark:hover:border-primary-500/30 hover:bg-primary-50 dark:hover:bg-primary-500/10 hover:shadow-md transition-all cursor-pointer"
                        ...
                        whileTap={{ scale: 0.98 }}
                      >
                        <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{city.cityName}</p>
                      </motion.div>
                    ))}
                  </div>
                )}
            ...
            <Card>
              <CardContent className="p-8 sm:p-12">
                <div className="text-center">
                  <div className="mx-auto flex items-center justify-center h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-primary-100 dark:bg-primary-500/20 mb-3 sm:mb-4">
                  ...
                  <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-2">Select a State</h3>
